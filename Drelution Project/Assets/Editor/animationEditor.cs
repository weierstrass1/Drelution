    ...
    public override void OnInspectorGUI()
    {
        ...
        if (ac.animations == null || (ac.animations != null && numAnims != ac.animations.Length))
        {
            ...
            for (int i = 0; i < newA.Length; i++)
            {
                ...
                {
                    newA[i] = new animation(ac.transform.parent.gameObject.GetComponent<AnimatedObject>(), i);
                }
            }
        ...
        if (GUILayout.Button("Add a Animation"))
        {
            ...
            newA[ac.animations.Length] = new animation(ac.transform.parent.gameObject.GetComponent<AnimatedObject>(), ac.animations.Length);
        ...
        if (ac.animations != null)
        {
            ...
            for (int i = 0; i < ac.animations.Length; i++)
            {
                ...
                if (ac.animations[i].fold)
                {
                    ...
                    ac.animations[i].AnimationReduction = EditorGUILayout.FloatField("Animation Reduction", ac.animations[i].AnimationReduction);
                    ...
                    if (GUILayout.Button("Add a Frame"))
                    {
                        ...
                        Action[] StartAction = new Action[numFrameLists + 1];
                        Action[] EndAction = new Action[numFrameLists + 1];
                        ...
                        StartAction[numFrameLists] = default(Action);
                        EndAction[numFrameLists] = default(Action);
